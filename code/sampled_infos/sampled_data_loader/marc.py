...
from data_loader.marc import MARCDataset


class SampledMARCDataset(MARCDataset):
    def __init__(self, num_shots, group_index):
        super(SampledMARCDataset, self).__init__()
        # override name and trn_egs
        self.name = f"marc-{num_shots}_shots-{group_index}_th"
        self.num_shots = num_shots
        self.group_index = group_index
        self.update_egs()

    def update_egs(self):
        sampled_mldoc_ = "./sampled_infos/sampled_data/marc/"
